...
class PartsTable{
    public function showPartsTable(){	
        ...
        if (isset($_GET["hiddenProfile"]) && $_GET["hiddenProfile"] == "Special") {
            ...
            $buttons =  "<div class='btn-group'><button class='btn btn-warning btnEditPart' idPart='".$parts[$i]["id"]."' data-toggle='modal' data-target='#EditPart'><i class='fa fa-pencil'></i></button></div>";
